...
/** Resolves PlexonCore reflectively so its API is never linked when the optional plugin is absent. */
public final class CoreBridgeFactory {
    private static final String CORE_PLUGIN = "PlexonCore";
    private static final String CORE_BRIDGE_CLASS = "com.antondev.chats.integration.core.PlexonCoreBridge";
